...
-   The currency is based on the country code of your Signal number.
-   To convert to a different currency, go to [Signal Settings](https://support.signal.org/hc/articles/360009091591) ![profile_avatar.png](https://support.signal.org/hc/article_attachments/360091706271/profile_avatar.png) > Payments > Menu > Set Currency > select the currency.
-   The currency conversion will apply for the existing balance. This does not apply to past transactions.

### Currency Conversion Freshness

-   Currency conversions are estimated prices that should be used as a guide at the time of transfer.
-   Currency conversions will fluctuate as exchange rates are changing.
-   Currency conversions are calculated using <https://fixer.io/> and <https://ftx.com/>.
